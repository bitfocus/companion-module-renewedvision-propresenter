...
- (New) Added new variable for clock total seconds: 'pro7*clock_n_totalseconds' (where n = clock index) \_This is good for feedback - eg change colour when countdown timer value is <0*
